...
typedef void (*iaisf_plugin_log_fn)(
    void* context,
    uint32_t level,
    iaisf_plugin_string_view message);

typedef void* (*iaisf_plugin_allocate_fn)(void* context, size_t size);
typedef void (*iaisf_plugin_deallocate_fn)(void* context, void* memory);
...
typedef iaisf_plugin_status_t (*iaisf_plugin_get_metadata_fn)(
    void* plugin_context,
    iaisf_plugin_metadata* metadata);

typedef iaisf_plugin_status_t (*iaisf_plugin_create_fn)(
    void* plugin_context,
    const iaisf_plugin_host_api* host,
    iaisf_plugin_handle** instance);

typedef iaisf_plugin_status_t (*iaisf_plugin_validate_fn)(
    iaisf_plugin_handle* instance,
    iaisf_plugin_bytes_view input);

typedef iaisf_plugin_status_t (*iaisf_plugin_output_fn)(
    void* context,
    iaisf_plugin_bytes_view chunk);

typedef iaisf_plugin_status_t (*iaisf_plugin_execute_fn)(
    iaisf_plugin_handle* instance,
    iaisf_plugin_bytes_view input,
    iaisf_plugin_output_fn output,
    void* output_context);

typedef iaisf_plugin_status_t (*iaisf_plugin_shutdown_fn)(
    iaisf_plugin_handle* instance);
typedef void (*iaisf_plugin_destroy_fn)(iaisf_plugin_handle* instance);
